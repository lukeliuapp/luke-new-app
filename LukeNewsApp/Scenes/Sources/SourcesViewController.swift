...
class SourcesViewController: LKLoadingViewController {
    enum DecorationType {
    ...
    private func setupBindings() {
        ...
        viewModel.content
            ...
            .drive(onNext: { content in
                ...
                snapshot.appendItems(content?.sourceContents.map {CellType.source($0)} ?? [])
        ...
        dataSource = UICollectionViewDiffableDataSource<Section, CellType>(
            ...
            cellProvider: { collectionView, indexPath, cellType in
                ...
                case let .source(content):
                    let cell: SourceListCell = collectionView.dequeueCell(indexPath: indexPath)
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        collectionView.register(SourceListCell.self)
...
extension SourcesViewController: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        switch cellType {
        case .source(let sourceContent):
            viewModel.addOrRemoveSelectedSourceId(with: sourceContent.id)
        }
    }
}
